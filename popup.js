window.onload = async function() {
  ...
  const toggle_muted_state_tab = allCommands.find(command => command.name === "toggle_muted_state_tab");
  const close_all_tabs_except_fixed = allCommands.find(command => command.name === "close_non_fixed_tabs");
  ...
  document.getElementById('toggle-muted-state-tab-command').textContent = toggle_muted_state_tab.shortcut;
  document.getElementById('close-non-fixed-command').textContent = close_all_tabs_except_fixed.shortcut;
  ...
  document.getElementById('toggle-muted-state-tab-description').textContent = toggle_muted_state_tab.description;
  document.getElementById('close-all-except-fixed-description').textContent = close_all_tabs_except_fixed.description;
}
